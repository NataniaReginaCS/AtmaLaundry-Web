...
<body>
    ...
    <section id="content">
        <aside class="sidebar">
            ...
            <div class="icon-feature-menu icon-bar">
                ...
                <a class="icon-link dashboard-link" href="{{ url('userDashboard') }}">
                ...
                <a class="icon-link service-link" href="{{ route('user.serviceList') }}">
                ...
                <a class="icon-link order-link" href="{{ url('orderList') }}">
            ...
            <div class="icon-user-menu icon-bar">
                ...
                <a class="icon-link profile-link" href="{{ url('profile') }}">
                    <div class="profile-icon icon">
                        <i class="bi bi-person-circle "></i>
                    </div>
                    <p class="text-icon account-text">Account</p>
                </a>
    ...
    <!-- Script Sidebar -->
    <script src="{{ asset('js/userSidebar.js') }}"></script>
