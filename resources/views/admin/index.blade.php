...
<section id="admin-dashboard">
    ...
    <div class="list-menu">
        <div class="menu shadow">
            <a href="{{ url('/adminOrderList?nama_kategori=Pakaian')}}" class="nav-link">
        ...
        <div class="menu shadow">
            <a href="{{ url('/adminOrderList?nama_kategori=Bed Cover')}}" class="nav-link">
        ...
        <div class="menu shadow">
            <a href="{{ url('/adminOrderList?nama_kategori=Boneka')}}" class="nav-link">
        ...
        <div class="menu shadow">
            <a href="{{ url('/adminOrderList')}}" class="nav-link">
